...
function run() {
    ...
    const render = () => root.render(React.createElement(StoryTable, { stories, postAppMessage }));

    const injectDownloadButtons = setupDownloadButtonInjection(() => stories, postAppMessage);
